...
const PRODUCTS = [
  ...
  {
    title: "The New Income Hack",
    description:
      "The guide to increase your income that was hidden by many. 6 proven frameworks to unlock multiple income streams. Anyone can do it, anyone can earn it.",
    imageSrc: "https://placehold.co/400x550/8b5cf6/ffffff?text=Income+Hack",
    route: "/income-hack",
